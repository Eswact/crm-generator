...
const datatableHelper = {
    ...
    initializeDataTable: function (name, selector, ajaxReq, tableColumns, options = {}) {
        ...
        if (options.fnInitComplete) {
            ...
            options.fnInitComplete = function () {
                $(`.${name}Toolbar`).html(`<button id="open${name}CT" class="p-2 px-4 flex items-center gap-2 bg-main text-white shadow-md text-xl rounded-lg">
    ...
    openCTModal: function (table, tableColumns) {
        ...
        let modalHtml = `<div class="w-full h-full flex flex-col gap-4">
                            ...
                            <div id="columnList" class="h-[calc(70%-2rem)]">
                                <ul class="w-full h-full overflow-y-autoflex flex flex-col gap-2">
                            ...
                            <div class="w-full h-[15%] flex flex-col justify-between">
                                <button  id="save${name}CT" class="w-full bg-second text-white font-semibold text-xl text-center py-2 rounded-lg">Save</button>
                                <button id="reset${name}CT" class="w-full border border-second text-second font-semibold text-xl text-center py-2 rounded-lg">Reset to default</button>
                            </div>
                        </div>`;
