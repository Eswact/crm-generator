...
let createdAutomatTableOperations = {"add":{"title":"Yeni Otomat Oluştur","url":"http://localhost:44350/production/set-automat","method":"POST","data":[{"name":"plaka","title":"Plate","type":"string","required":true,"value":"","placeholder":"xxx-xx-xxx","errorChecks":[{"control":"return value != null && value != '' && value.length > 4;","errMessage":"Plate must be longer than 4 characters."}],"visible":true},{"name":"model","title":"Model","type":"select","required":true,"options":[{"value":"","label":"Seçim yapınız"},{"value":"CD636047-CE35-43D4-A82D-AF0943BB63BE","label":"AA-91"},{"value":"CD636047-CE35-43D4-A82D-AF0943BB63BE","label":"AA-92"}],"showAllErrors":false,"errorChecks":[{"control":"return value != null && value != ''","errMessage":"Model cannot be null."}],"visible":true},{"name":"serialNumber","title":"Serial number","type":"number","required":true,"value":"","placeholder":"xxxxxxxxxxx","showAllErrors":true,"errorChecks":[{"control":"return value != null && value != '' && value.length > 7","errMessage":"Serial number must be longer than 7 characters."},{"control":"return !value.startsWith('000')","errMessage":"Serial number cannot start with 000."}],"visible":true},{"name":"androidImei","title":"Android imei","type":"string","required":true,"value":"","placeholder":"xx-xx-xx-xx","showAllErrors":false,"errorChecks":[{"control":"return value != null && value != '' && value.length > 4;","errMessage":"Android imei must be longer than 4 characters."}],"visible":true},{"name":"androidMac","title":"Android mac","type":"string","required":true,"value":"","placeholder":"xx-xx-xx-xx","showAllErrors":false,"errorChecks":[{"control":"return value != null && value != '' && value.length > 4;","errMessage":"Android mac must be longer than 4 characters."}],"visible":true},{"name":"modemImei","title":"Modem imei","type":"string","required":true,"value":"","showAllErrors":false,"errorChecks":[{"control":"return value != null && value != '' && value.length > 4;","errMessage":"Modem imei must be longer than 4 characters."}],"visible":true},{"name":"modemMac","title":"Modem mac","type":"string","required":true,"value":"","showAllErrors":false,"errorChecks":[{"control":"return value != null && value != '' && value.length > 4;","errMessage":"Modem mac must be longer than 4 characters."}],"visible":true},{"name":"plcImei","title":"Plc imei","type":"string","required":false,"value":"","showAllErrors":false,"errorChecks":[{"control":"return value == '' || value.length > 4;","errMessage":"Plc imei must be longer than 4 characters."}],"visible":true},{"name":"plcMac","title":"Plc mac","type":"string","required":false,"value":"","showAllErrors":false,"errorChecks":[{"control":"return !value.startsWith('000')","errMessage":"Serial number cannot start with 000."}],"visible":true},{"name":"defaultData","value":true,"visible":false}]},"edit":{"title":"Otomat Düzenle","url":"http://localhost:44350/production/update-automat","method":"POST","data":[{"name":"manufactId","value":"selectedRow.manufactId","visible":false},{"name":"plaka","value":"selectedRow.plate","visible":false},{"name":"serialNumber","value":"selectedRow.snAndroid","visible":false},{"name":"model","title":"Model","type":"select","value":"selectedRow.modelID","options":[{"value":"","label":"Seçim yapınız"},{"value":"CD636047-CE35-43D4-A82D-AF0943BB63BE","label":"AA-91"},{"value":"CD636047-CE35-43D4-A82D-AF0943BB63BE","label":"AA-92"}],"required":true,"showAllErrors":false,"errorChecks":[{"control":"return value != null && value != ''","errMessage":"Model cannot be null."}],"visible":true},{"name":"androidImei","title":"Android imei","type":"string","value":"selectedRow.imeiAndroid","placeholder":"xx-xx-xx-xx","required":true,"showAllErrors":false,"errorChecks":[{"control":"return value != null && value != '' && value.length > 4;","errMessage":"Android imei must be longer than 4 characters."}],"visible":true},{"name":"androidMac","title":"Android mac","type":"string","value":"selectedRow.macAndroid","placeholder":"xx-xx-xx-xx","required":true,"showAllErrors":false,"errorChecks":[{"control":"return value != null && value != '' && value.length > 4;","errMessage":"Android mac must be longer than 4 characters."}],"visible":true},{"name":"modemImei","title":"Modem imei","type":"string","value":"selectedRow.imeimodem","required":true,"showAllErrors":false,"errorChecks":[{"control":"return value != null && value != '' && value.length > 4;","errMessage":"Modem imei must be longer than 4 characters."}],"visible":true},{"name":"modemMac","title":"Modem mac","type":"string","value":"selectedRow.macmodem","required":true,"showAllErrors":false,"errorChecks":[{"control":"return value != null && value != '' && value.length > 4;","errMessage":"Modem mac must be longer than 4 characters."}],"visible":true},{"name":"plcImei","title":"Plc imei","type":"string","value":"selectedRow.imeiplc","required":true,"showAllErrors":false,"errorChecks":[{"control":"return value != null && value != '' && value.length > 4;","errMessage":"Plc imei must be longer than 4 characters."}],"visible":true},{"name":"plcMac","title":"Plc mac","type":"string","value":"selectedRow.macplc","required":true,"showAllErrors":false,"errorChecks":[{"control":"return value != null && value != '' && value.length > 4;","errMessage":"Plc mac must be longer than 4 characters."}],"visible":true}]},"delete":{"url":"http://localhost:44350/production/delete-automat","method":"POST","data":{"manufactIds":["selectedRow.manufactId"]}}}
